...
public final class OutbrainSfeedSingleItemCustomBinding implements ViewBinding {
    ...
    private OutbrainSfeedSingleItemCustomBinding(LinearLayout linearLayout, OBCardView oBCardView, TextView textView, ImageView imageView, RelativeLayout relativeLayout, TextView textView2, TextView textView3, LinearLayout linearLayout2, View view, ConstraintLayout constraintLayout, ImageView imageView2, ImageView imageView3) {
    ...
    public static OutbrainSfeedSingleItemCustomBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.outbrain_sfeed_single_item_custom, viewGroup, false);
        if (z) {
                                ...
                                if (viewFindChildViewById != null) {
                                    ...
                                    if (constraintLayout != null) {
                                        ...
                                        if (imageView2 != null) {
                                            ...
                                            if (imageView3 != null) {
                                                return new OutbrainSfeedSingleItemCustomBinding(linearLayout, oBCardView, textView, imageView, relativeLayout, textView2, textView3, linearLayout, viewFindChildViewById, constraintLayout, imageView2, imageView3);
                                            }
                                        }
                                    }
                                }
