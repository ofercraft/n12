...
public class TeaserRegularItemSmallRoundNoCaption extends CustomRecyclerViewHolder {
    ...
    public TeaserRegularItemSmallRoundNoCaption(View view) {
        super(view);
