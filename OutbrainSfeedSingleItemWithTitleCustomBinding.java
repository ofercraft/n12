...
public final class OutbrainSfeedSingleItemWithTitleCustomBinding implements ViewBinding {
    ...
    public final LinearLayout obSfSingleItem;
    ...
    private OutbrainSfeedSingleItemWithTitleCustomBinding(LinearLayout linearLayout, OBCardView oBCardView, TextView textView, ImageView imageView, RelativeLayout relativeLayout, TextView textView2, TextView textView3, LinearLayout linearLayout2, View view, RelativeLayout relativeLayout2, TextView textView4, ConstraintLayout constraintLayout, ImageView imageView2, ImageView imageView3) {
        ...
        this.obSfSingleItem = linearLayout2;
    ...
    public static OutbrainSfeedSingleItemWithTitleCustomBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static OutbrainSfeedSingleItemWithTitleCustomBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.outbrain_sfeed_single_item_with_title_custom, viewGroup, false);
        if (z) {
    ...
    public static OutbrainSfeedSingleItemWithTitleCustomBinding bind(View view) {
        int i = R.id.cv;
                                        ...
                                        if (textView4 != null) {
                                            ...
                                            if (constraintLayout != null) {
                                                ...
                                                if (imageView2 != null) {
                                                    ...
                                                    if (imageView3 != null) {
                                                        return new OutbrainSfeedSingleItemWithTitleCustomBinding(linearLayout, oBCardView, textView, imageView, relativeLayout, textView2, textView3, linearLayout, viewFindChildViewById, relativeLayout2, textView4, constraintLayout, imageView2, imageView3);
                                                    }
                                                }
                                            }
                                        }
