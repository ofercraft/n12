...
public class LobbyChatVHMediaAndTextReply extends LobbyChatViewModel {
    ...
    public LobbyChatVHMediaAndTextReply(View view) {
        super(view);
    ...
    public void setViewResources(Item item, LobbyFragmentHandler lobbyFragmentHandler) {
        ...
        if (chatReportItem.getReply().getNumberOfMedias() > 0) {
            ...
            this.ContentReply.setText(chatReportItem.getReply().getChatMedia(0).getMediaContent());
        }
