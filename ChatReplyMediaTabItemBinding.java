...
public final class ChatReplyMediaTabItemBinding implements ViewBinding {
    ...
    public static ChatReplyMediaTabItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.chat_reply_media_tab_item, viewGroup, false);
        if (z) {
                                                        ...
                                                        if (imageView5 != null) {
                                                            ...
                                                            if (imageView6 != null) {
                                                                ...
                                                                if (textView6 != null) {
                                                                    ...
                                                                    if (textView7 != null) {
                                                                        return new ChatReplyMediaTabItemBinding(constraintLayout2, constraintLayout, textView, textView2, viewFindChildViewById, imageView, imageView2, imageView3, button, constraintLayout2, textView3, imageView4, textView4, textView5, imageView5, imageView6, textView6, textView7);
                                                                    }
                                                                }
                                                            }
                                                        }
