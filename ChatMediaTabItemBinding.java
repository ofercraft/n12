...
public final class ChatMediaTabItemBinding implements ViewBinding {
    ...
    public static ChatMediaTabItemBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static ChatMediaTabItemBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View viewInflate = layoutInflater.inflate(R.layout.chat_media_tab_item, viewGroup, false);
        if (z) {
    ...
    public static ChatMediaTabItemBinding bind(View view) {
        int i = R.id.bg;
                                            ...
                                            if (imageView5 != null) {
                                                ...
                                                if (imageView6 != null) {
                                                    ...
                                                    if (textView4 != null) {
                                                        ...
                                                        if (textView5 != null) {
                                                            return new ChatMediaTabItemBinding((ConstraintLayout) view, constraintLayout, textView, imageView, imageView2, imageView3, button, textView2, imageView4, textView3, imageView5, imageView6, textView4, textView5);
                                                        }
                                                    }
                                                }
                                            }
